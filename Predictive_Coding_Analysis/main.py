...
# Klasa Pixel reprezentuje piksel ze składnikami koloru (czerwony, zielony, niebieski)
class Pixel:
...
# Funkcja new_scheme implementuje schemat predykcyjny dla JPEG-LS
...
# Funkcja jpeg_ls koduje przy użyciu predyktorów JPEG-LS
def jpeg_ls(bitmap, scheme):
    ...
    for i, row in enumerate(bitmap):
        ...
        for j, pixel in enumerate(row):
            ...
            # Oblicz różnicę między oryginalnym pikselem a przewidywaną wartością
            encoded_row.append((pixel - scheme(n, w, nw)) % 256)
        result.append(encoded_row)
    return result

# Funkcja parse_bitmap konwertuje bajty obrazu na listę pikseli
...
# Funkcja entropii oblicza entropię przy danych częstotliwościach i całkowitej liczbie elementów
...
# Funkcja obliczenia entropii oblicza entropię dla danego składnika koloru
...
if __name__ == "__main__":
    if len(argv) == 2:
        with open(argv[1], "rb") as f:
            ...
            # Określ optymalne metody kodowania
